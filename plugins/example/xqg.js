...
export class example extends plugin {
  constructor() {
    super({
      ...
      name: '随机图片和保存图片',
      /** 功能描述 */
      dsc: '发送随机图片，并在收到 “上传xqg” + 图片 时保存到 xqg 文件夹',
      event: 'message',
      /** 优先级，数字越小等级越高 */
      priority: -1145141919,
      rule: [
  ...
  // 通用下载并保存到 resources/xqg/ 的逻辑
  async _downloadAndSave(e) {
    const folder = process.cwd() + '/resources/xqg/';
    try {
