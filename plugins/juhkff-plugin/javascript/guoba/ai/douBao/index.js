        ...
        componentProps: {
            ...
            schemas: [
                ...
                },
                {
                    field: "seed",
                    label: "种子",
                    bottomHelpMessage: "随机数种子，取值范围为 [-1, 2147483647]。-1 为算法随机生成。如果希望生成内容保持一致，可以使用相同的 seed 参数值",
                ...
                },
                {
                    ...
                    label: " 一致程度",
                    bottomHelpMessage: "值越大，模型自由度越小，与用户输入的提示词相关性越强。取值范围：[1.0, 10.0]",
                    component: "InputNumber",
                    componentProps: {
                        min: 1,
                        max: 10,
